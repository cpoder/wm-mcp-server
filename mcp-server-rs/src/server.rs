    ...
    fn get_info(&self) -> ServerInfo {
        ServerInfo::new(
            ...
            .with_instructions(concat!(
                ...
                "ADAPTER SERVICE CREATION:\n",
                "1. adapter_service_template_list(connection_alias) -> list available templates (Select, Insert, CustomSQL, etc.)\n",
                "2. adapter_service_template_metadata(connection_alias, service_template) -> get all parameters and their types\n",
                "3. adapter_resource_domain_lookup(...) -> browse valid values for each parameter interactively\n",
                "4. adapter_service_create(...) -> create the service\n",
                "5. adapter_service_get(service_name) -> verify the configuration\n\n",
                "STREAMING (Kafka):\n",
